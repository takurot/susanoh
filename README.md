...
- 縮小 Regression-Live: `.github/workflows/testbench-regression-live.yml` が毎週月曜 `05:00 JST` (`20:00 UTC` 日曜) に staging 向けの4シナリオを `live` モードで実行します。必要な staging secrets が未設定の場合はジョブをスキップします。
